...
;
;
function ToastProvider({ flash }) {
    _s();
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ToastProvider.useEffect": ()=>{
            const run = {
                "ToastProvider.useEffect.run": async ()=>{
                    ...
                    const flash = await cookieStore.get('flash');
                }
            }["ToastProvider.useEffect.run"];
            run();
        }
    }["ToastProvider.useEffect"], []);
...
_s(ToastProvider, "OD7bBpZva5O2jO+Puf00hKivP7c=");
_c = ToastProvider;
var _c;
...
//# sourceMappingURL=src_app_components_ToastProvider_tsx_17b645d2._.js.map