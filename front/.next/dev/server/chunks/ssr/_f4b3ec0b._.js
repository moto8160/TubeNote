module.exports = [
"[project]/src/features/login/data:bd8d6d [app-ssr] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$login$2f$data$3a$bd8d6d__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/features/login/data:bd8d6d [app-ssr] (ecmascript) <text/javascript>");
...
function LoginForm() {
    ...
    const handleSubmit = async (formData)=>{
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$login$2f$data$3a$bd8d6d__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["login"])(formData);
        if (!result.success) {
...
//# sourceMappingURL=_f4b3ec0b._.js.map